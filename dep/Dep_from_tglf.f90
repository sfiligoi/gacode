...
!
  ...
  ! PRIVATE PARAMETERS
  ! Number  of n-modes:  nk_max  = 10  ! same as low-k tglf default
    integer, parameter :: nk_max = 10
  ! Maximum number of unstable modes at each ky  nmodes_max = 2! tglf default 
    integer, parameter :: nmodes_max =2
  ...
  !tglf mode values
    ...
    real ::  chi_i_tglf_wt(nk_max,nmodes_max)
    ...
    complex :: omega_tglf(nk_max,nmodes_max)   !(omega_re,omega_i)_tglf

    complex :: Rem(nk_max,nmodes_max) ! = delta_A_par_hat/delta_phi_hat
