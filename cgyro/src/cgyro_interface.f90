...
module cgyro_interface
  ...
  integer :: cgyro_e_method_in = 1
  integer :: cgyro_delta_t_method_in = 1
  ...
  integer :: cgyro_subroutine_flag_in = 0
  ...
  real, dimension(11) :: cgyro_sdlnndr_in = 0
  real, dimension(11) :: cgyro_sdlntdr_in = 0
  ...
  real :: cgyro_betae_unit_scale_in = 10
  ...
  complex :: cgyro_omega_out
  complex :: cgyro_omega_error_out
...
contains
  ...
  subroutine map_global2interface()
    ...
    cgyro_collision_ele_scale_in = collision_ele_scale
    ...
    cgyro_shape_s_sin3_in = shape_s_sin3
    cgyro_shape_cos0_in = shape_cos0
    cgyro_shape_s_cos0_in = shape_s_cos0
    cgyro_shape_cos1_in = shape_cos1
    cgyro_shape_s_cos1_in = shape_s_cos1
    cgyro_shape_cos2_in = shape_cos2
    cgyro_shape_s_cos2_in = shape_s_cos2
    cgyro_shape_cos3_in = shape_cos3
    cgyro_shape_s_cos3_in = shape_s_cos3
  ...
  subroutine map_interface2global()
    ...
    collision_ele_scale = cgyro_collision_ele_scale_in
    ...
    shape_s_sin3 = cgyro_shape_s_sin3_in
    shape_cos0 = cgyro_shape_cos0_in
    shape_s_cos0 = cgyro_shape_s_cos0_in
    shape_cos1 = cgyro_shape_cos1_in
    shape_s_cos1 = cgyro_shape_s_cos1_in
    shape_cos2 = cgyro_shape_cos2_in
    shape_s_cos2 = cgyro_shape_s_cos2_in
    shape_cos3 = cgyro_shape_cos3_in
    shape_s_cos3 = cgyro_shape_s_cos3_in
  ...
  subroutine interfacelocaldump
    ...
    write(1,30) 'COLLISION_ELE_SCALE',cgyro_collision_ele_scale_in
    ...
    write(1,20) 'NONLINEAR_METHOD',cgyro_nonlinear_method_in
...
30  format(a,'=',1pe12.5)
    ...
    if (i_proc .eq. 0 .and. debug .eq. 1) then
