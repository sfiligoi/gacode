subroutine cgyro_equilibrium
  ...
  geo_shape_cos4_in = 0.0
  geo_shape_cos5_in = 0.0
  geo_shape_cos6_in = 0.0
  geo_shape_sin3_in = shape_sin3
  geo_shape_sin4_in = 0.0
  geo_shape_sin5_in = 0.0
  geo_shape_sin6_in = 0.0
  ...
  geo_shape_s_cos4_in = 0.0
  geo_shape_s_cos5_in = 0.0
  geo_shape_s_cos6_in = 0.0
  geo_shape_s_sin3_in = shape_s_sin3
  geo_shape_s_sin4_in = 0.0
  geo_shape_s_sin5_in = 0.0
  geo_shape_s_sin6_in = 0.0
