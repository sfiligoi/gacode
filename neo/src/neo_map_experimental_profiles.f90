  ...
  if(prof_check_flag) then
     if(write_out_mode > 0 .and. i_proc == 0) then
        ...
        do ir=1,n_grid_exp
           ...
           write (30,'(e16.8,$)') rmaj_p(ir)
           write (30,'(e16.8,$)') q_exp(ir)
           write (30,'(e16.8,$)') kappa_exp(ir)
           write (30,'(e16.8,$)') s_kappa_p(ir)
           write (30,'(e16.8,$)') delta_exp(ir)
           write (30,'(e16.8,$)') s_delta_p(ir)
           write (30,'(e16.8,$)') zeta_exp(ir)
           write (30,'(e16.8,$)') s_zeta_p(ir)
           write (30,'(e16.8,$)') shift_p(ir)
           write (30,'(e16.8,$)') zmag_p(ir)
           write (30,'(e16.8,$)') s_zmag_p(ir)
           do i=1,n_species_exp
              write (30,'(e16.8,$)') den_exp(i,ir)
              write (30,'(e16.8,$)') tem_exp(i,ir)
              write (30,'(e16.8,$)') dlnndr_p(i,ir)
              write (30,'(e16.8,$)') dlntdr_p(i,ir)
           enddo
           write (30,'(e16.8,$)') dphi0dr_p(ir)
           write (30,*)
        enddo
        close(30)
        ...
        do ir=1,n_radial
           ...
           write (30,'(e16.8,$)') rmaj(ir)
           write (30,'(e16.8,$)') q(ir)
           write (30,'(e16.8,$)') kappa(ir)
           write (30,'(e16.8,$)') s_kappa(ir)
           write (30,'(e16.8,$)') delta(ir)
           write (30,'(e16.8,$)') s_delta(ir)
           write (30,'(e16.8,$)') zeta(ir)
           write (30,'(e16.8,$)') s_zeta(ir)
           write (30,'(e16.8,$)') shift(ir)
           write (30,'(e16.8,$)') zmag(ir)
           write (30,'(e16.8,$)') s_zmag(ir)
           do i=1,n_species
              write (30,'(e16.8,$)') dens(i,ir)
              write (30,'(e16.8,$)') temp(i,ir)
              write (30,'(e16.8,$)') dlnndr(i,ir)
              write (30,'(e16.8,$)') dlntdr(i,ir)
           enddo
           write (30,'(e16.8,$)') dphi0dr(ir)
           write (30,*)
        enddo
        close(30)
