subroutine neo_check
  ...
  if (silent_flag == 0 .and. i_proc == 0) then
     ...
     do ir=1,n_radial
        ...
        write(io_neoout,20) '     sin4:',shape_sin(5,ir), '   s_sin4:',shape_s_sin(5,ir)
        write(io_neoout,20) '     sin4:',shape_sin(6,ir), '   s_sin4:',shape_s_sin(6,ir)
        ...
        write(io_neoout,20) '     cos4:',shape_cos(5,ir), '   s_cos4:',shape_s_cos(5,ir)
        write(io_neoout,20) '     cos4:',shape_cos(6,ir), '   s_cos4:',shape_s_cos(6,ir)
