...
contains
  ...
  subroutine PROFILE_SIM_alloc(flag)
    ...
    if(flag == 1) then
       ...
       allocate(shape_sin4(n_radial))
       allocate(shape_s_sin4(n_radial))
       ...
       allocate(shape_cos4(n_radial))
       allocate(shape_s_cos4(n_radial))
       ...
       deallocate(shape_sin4)
       deallocate(shape_s_sin4)
       ...
       deallocate(shape_cos4)
       deallocate(shape_s_cos4)
