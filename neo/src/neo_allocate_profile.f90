...
contains
  ...
  subroutine PROFILE_SIM_alloc(flag)
    ...
    if(flag == 1) then
       ...
       allocate(shape_sin(0:n_shape,n_radial))
       allocate(shape_s_sin(0:n_shape,n_radial))
       allocate(shape_cos(0:n_shape,n_radial))
       allocate(shape_s_cos(0:n_shape,n_radial))
       ...
       deallocate(zeta)
       deallocate(s_zeta)
       deallocate(shape_sin)
       deallocate(shape_s_sin)
       deallocate(shape_cos)
       deallocate(shape_s_cos)
