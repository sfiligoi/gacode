...
module neo_interface
  ...
  integer :: neo_ae_flag_in = 0
  real    :: neo_dens_ae_in = 1.0
  real    :: neo_temp_ae_in = 1.0
  real    :: neo_dlnndr_ae_in  = 1.0
  real    :: neo_dlntdr_ae_in  = 1.0
  ...
  real    :: neo_shape_sin5_in = 0.0
  real    :: neo_shape_s_sin5_in = 0.0
  real    :: neo_shape_sin6_in = 0.0
  real    :: neo_shape_s_sin6_in = 0.0
  real    :: neo_shape_cos0_in = 0.0
  real    :: neo_shape_s_cos0_in = 0.0
  real    :: neo_shape_cos1_in = 0.0
  real    :: neo_shape_s_cos1_in = 0.0
  real    :: neo_shape_cos2_in = 0.0
  ...
  real    :: neo_shape_cos5_in = 0.0
  real    :: neo_shape_s_cos5_in = 0.0
  real    :: neo_shape_cos6_in = 0.0
  real    :: neo_shape_s_cos6_in = 0.0
  ...
  real    :: neo_jpar_thSmod_out = 0.0
  real    :: neo_jtor_thSmod_out = 0.0
  ! drift-kinetic soln
...
contains
  ...
  subroutine map_global2interface()
    ...
    neo_ae_flag_in = ae_flag
    neo_dens_ae_in = dens_ae_in
    neo_temp_ae_in = temp_ae_in
    neo_dlnndr_ae_in = dlnndr_ae_in
    neo_dlntdr_ae_in = dlntdr_ae_in
    ...
    neo_shape_sin3_in = shape_sin_in(3)
    neo_shape_s_sin3_in = shape_s_sin_in(3)
    neo_shape_sin4_in = shape_sin_in(4)
    neo_shape_s_sin4_in = shape_s_sin_in(4)
    neo_shape_sin5_in = shape_sin_in(5)
    neo_shape_s_sin5_in = shape_s_sin_in(5)
    neo_shape_sin6_in = shape_sin_in(6)
    neo_shape_s_sin6_in = shape_s_sin_in(6)
    neo_shape_cos0_in = shape_cos_in(0)
    neo_shape_s_cos0_in = shape_s_cos_in(1)
    neo_shape_cos1_in = shape_cos_in(1)
    neo_shape_s_cos1_in = shape_s_cos_in(1)
    neo_shape_cos2_in = shape_cos_in(2)
    neo_shape_s_cos2_in = shape_s_cos_in(2)
    neo_shape_cos3_in = shape_cos_in(3)
    neo_shape_s_cos3_in = shape_s_cos_in(3)
    neo_shape_cos4_in = shape_cos_in(4)
    neo_shape_s_cos4_in = shape_s_cos_in(4)
    neo_shape_cos5_in = shape_cos_in(5)
    neo_shape_s_cos5_in = shape_s_cos_in(5)
    neo_shape_cos6_in = shape_cos_in(6)
    neo_shape_s_cos6_in = shape_s_cos_in(6)
  ...
  subroutine map_interface2global()
    ...
    ae_flag = neo_ae_flag_in
    dens_ae_in = neo_dens_ae_in
    temp_ae_in = neo_temp_ae_in
    dlnndr_ae_in = neo_dlnndr_ae_in
    dlntdr_ae_in = neo_dlntdr_ae_in
    ...
    shape_sin_in(3)   = neo_shape_sin3_in
    shape_s_sin_in(3) = neo_shape_s_sin3_in
    shape_sin_in(4)   = neo_shape_sin4_in
    shape_s_sin_in(4) = neo_shape_s_sin4_in
    shape_sin_in(5)   = neo_shape_sin5_in
    shape_s_sin_in(5) = neo_shape_s_sin5_in
    shape_sin_in(6)   = neo_shape_sin6_in
    shape_s_sin_in(6) = neo_shape_s_sin6_in
    shape_cos_in(0)   = neo_shape_cos0_in
    shape_s_cos_in(0) = neo_shape_s_cos0_in
    shape_cos_in(1)   = neo_shape_cos1_in
    shape_s_cos_in(1) = neo_shape_s_cos1_in
    shape_cos_in(2)   = neo_shape_cos2_in
    shape_s_cos_in(2) = neo_shape_s_cos2_in
    shape_cos_in(3)   = neo_shape_cos3_in
    shape_s_cos_in(3) = neo_shape_s_cos3_in
    shape_cos_in(4)   = neo_shape_cos4_in
    shape_s_cos_in(4) = neo_shape_s_cos4_in
    shape_cos_in(5)   = neo_shape_cos5_in
    shape_s_cos_in(5) = neo_shape_s_cos5_in
    shape_cos_in(6)   = neo_shape_cos6_in
    shape_s_cos_in(6) = neo_shape_s_cos6_in
  ...
  subroutine interfacelocaldump
    ...
    write(1,20) 'AE_FLAG=',neo_ae_flag_in
    write(1,30) 'DENS_AE=',neo_dens_ae_in
    write(1,30) 'TEMP_AE=',neo_temp_ae_in
    write(1,30) 'DLNNDR_AE=',neo_dlnndr_ae_in
    write(1,30) 'DLNTDR_AE=',neo_dlntdr_ae_in
    ...
    write(1,30) 'SHAPE_SIN5=',neo_shape_sin5_in
    write(1,30) 'SHAPE_S_SIN5=',neo_shape_s_sin5_in
    write(1,30) 'SHAPE_SIN6=',neo_shape_sin6_in
    write(1,30) 'SHAPE_S_SIN6=',neo_shape_s_sin6_in
    ...
    write(1,30) 'SHAPE_S_COS1=',neo_shape_s_cos1_in
    write(1,30) 'SHAPE_COS2=',neo_shape_cos2_in
    ...
    write(1,30) 'SHAPE_COS5=',neo_shape_cos5_in
    write(1,30) 'SHAPE_S_COS5=',neo_shape_s_cos5_in
    write(1,30) 'SHAPE_COS6=',neo_shape_cos6_in
    write(1,30) 'SHAPE_S_COS6=',neo_shape_s_cos6_in
