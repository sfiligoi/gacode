...
!   '# Control parameters:'
!   '#---------------------------------------------------'
    ierr=set_harvest_payload_swt(harvest_sendline,'NS'//NUL,tglf_ns_in)
...
!    ierr=set_harvest_payload_swt(harvest_sendline,'GEOMETRY_FLAG'//NUL,tglf_geometry_flag_in) ! DISABLED because we only allow Miller geometry
    ...
    ierr=set_harvest_payload_swt(harvest_sendline,'SAT_RULE'//NUL,tglf_sat_rule_in)
    ierr=set_harvest_payload_swt(harvest_sendline,'KYGRID_MODEL'//NUL,tglf_kygrid_model_in)
    ierr=set_harvest_payload_swt(harvest_sendline,'XNU_MODEL'//NUL,tglf_xnu_model_in)
    ierr=set_harvest_payload_swt(harvest_sendline,'VPAR_MODEL'//NUL,tglf_vpar_model_in)
    ierr=set_harvest_payload_swt(harvest_sendline,'VPAR_SHEAR_MODEL'//NUL,tglf_vpar_shear_model_in)
...
!    ierr=set_harvest_payload_bol(harvest_sendline,'NEW_EIKONAL'//NUL,tglf_new_eikonal_in) ! DISABLED because we only allow freshly computed eikonal
    ...
    ierr=set_harvest_payload_swt(harvest_sendline,'IBRANCH'//NUL,tglf_ibranch_in)
    ierr=set_harvest_payload_swt(harvest_sendline,'NMODES'//NUL,tglf_nmodes_in)
!    ierr=set_harvest_payload_swt(harvest_sendline,'NBASIS_MAX'//NUL,tglf_nbasis_max_in) ! DISABLED because not physics inputs/outputs
!    ierr=set_harvest_payload_swt(harvest_sendline,'NBASIS_MIN'//NUL,tglf_nbasis_min_in) ! DISABLED because not physics inputs/outputs
    ierr=set_harvest_payload_swt(harvest_sendline,'NXGRID'//NUL,tglf_nxgrid_in)
    ierr=set_harvest_payload_swt(harvest_sendline,'NKY'//NUL,tglf_nky_in)
...
!    ierr=set_harvest_payload_swt(harvest_sendline,'WRITE_WAVEFUNCTION_FLAG'//NUL,tglf_write_wavefunction_flag_in)  ! DISABLED because not physics inputs/outputs
...
!   '#---------------------------------------------------'
    ...
    ierr=set_harvest_payload_swt(harvest_sendline,'NWIDTH'//NUL,tglf_nwidth_in)
