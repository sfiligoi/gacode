...
!
 ...
 character(100) :: gname
!-------------------------
   fname=trim(tglf_dump_path_in)//"dump_inputs.txt"
   open(unit=funit,file=trim(fname),status='replace')
   gname=trim(tglf_dump_path_in)//"gen_input.dat"
 ...
 write(21,*) "tglf_vpar_shear_in = ",tglf_vpar_shear_in
 write(22,*) tglf_vpar_shear_in
 ...
 write(21,*) "tglf_xnuei_in = ",tglf_xnuei_in
 write(22,*) tglf_xnuei_in
 write(21,*) "tglf_debye_in = ",tglf_debye_in
 write(22,*) tglf_debye_in
 write(21,*) "tglf_vexb_mach_in = ",tglf_vexb_mach_in
 write(22,*) tglf_vexb_mach_in
 write(21,*) "tglf_vpar_mach_in = ",tglf_vpar_mach_in
 write(22,*) tglf_vpar_mach_in
 ...
 write(21,*) "tglf_shift_loc_in = ",tglf_shift_loc_in
 write(22,*) tglf_shift_loc_in
 ...
 write(21,*) "tglf_x_psi_in = ",tglf_x_psi_in
 write(22,*) tglf_x_psi_in
  close(funit)
!
