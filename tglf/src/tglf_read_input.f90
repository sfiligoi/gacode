subroutine tglf_read_input
  ...
  open(unit=1,file='INPUT.gen',status='old')
  ...
  read(1,*) tglf_xnuei_in
  read(1,*) tglf_debye_in
  read(1,*) tglf_vexb_mach_in
  read(1,*) tglf_vpar_mach_in
