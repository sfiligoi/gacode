...
subroutine tgyro_read_input
  ...
  call tgyro_readbc_int(tgyro_neo_method) 
  call tgyro_readbc_int(loc_n_ion) 
  call tgyro_readbc_int(calc_flag(1)) 
  call tgyro_readbc_int(calc_flag(2)) 
  call tgyro_readbc_int(calc_flag(3)) 
  call tgyro_readbc_int(calc_flag(4)) 
  call tgyro_readbc_int(calc_flag(5)) 
  call tgyro_readbc_int(calc_flag(6)) 
  call tgyro_readbc_int(calc_flag(7)) 
  call tgyro_readbc_int(calc_flag(8)) 
  call tgyro_readbc_int(calc_flag(9)) 
  ...
  call tgyro_readbc_int(tgyro_tglf_ptot_flag)
  call tgyro_readbc_int(tgyro_tglf_geometry_flag)
  ...
  call tgyro_readbc_int(tgyro_consistent_flag)
  ...
  call tgyro_readbc_int(tgyro_neo_n_xi)
  call tgyro_readbc_int(tgyro_neo_n_energy)
  ...
  call tgyro_readbc_int(tgyro_cgyro_n_iterate)
