...
subroutine post77(te,name,lz,n)
  ...
  if (name == 'He') then
     ...
     ! Neon (A=20,Z=10) [could have transcription errors from Post]
     c(1,:) = (/8.000e-03,2.000e-02, 6.76767e+01, 1.61379e+02, 1.10477e+02, 3.19875e+01, 3.14315e+00,0.0/)
     c(2,:) = (/2.000e-02,2.000e-01,-6.80502e+01,-2.58088e+02,-5.34686e+02,-5.28426e+02,-2.47633e+02,-4.42550e+01/)
     c(3,:) = (/2.000e-01,2.000e+00,-2.02269e+01,-1.14144e+00, 1.42833e+00, 1.08957e+00,-6.96990e+00,-3.70147e+00/)
     c(4,:) = (/2.000e+00,2.000e+01,-2.02199e+01,-1.10059e+00, 8.37712e-01, 1.70785e-01,-3.52240e-01, 1.04123e-01/)
     c(5,:) = (/2.000e+01,1.000e+02,-2.06491e+01, 8.83557e-02,-2.86403e-01, 4.44014e-01,-1.88168e-01, 2.71915e-02/)
