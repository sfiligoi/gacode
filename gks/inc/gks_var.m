...
!variable descripter file replaces common.inc
       ...
       integer, parameter :: ntm=48
! ntm=96
!for nperiod  less or eq 4
! ntm=144
! for ntheta=64 and nperiod=4
!ntm=224
        integer, parameter :: ntml=ntm
        integer, parameter :: nlm=59
! for ntheta=64
! nlm=43
...
********* start complex variables:
       ...
       complex  curtrap(0:1000,-ntml:ntm)                     !complex
       complex  curpass(0:1000,-ntml:ntm)                    !complex
       complex  wave(0:1000)                                 !complex
...
********* Basiscom:
       ...
       real  freqst(0:1000,0:20,nkgrid)                    !real
       real  gammast(0:1000,0:20,nkgrid)                   !real
       real  timest(0:1000)                                !real
       real  tp1_rec(0:1000,2)                               !real
       real  tp3_rec(0:1000,2)                               !real
       ...
       real  stkgammast(0:1000,0:20,nkgrid)                !real
