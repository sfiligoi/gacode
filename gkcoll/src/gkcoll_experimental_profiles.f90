!----------------------------------------------------------------
! gkcoll_experimental_profiles.f90
!
! PURPOSE:
...
subroutine gkcoll_experimental_profiles
  ...
  ! Determine if electrons are to be included in the gkcoll 
...
end subroutine gkcoll_experimental_profiles
