...
module gkcoll_interface
  ...
  real    :: gkcoll_k_theta_in  = 0.25
  real    :: gkcoll_r_length_in = 64.0
...
contains
  ...
  subroutine map_global2interface()
    ...
    gkcoll_k_theta_in  = k_theta
    gkcoll_r_length_in = r_length
    gkcoll_rmin_in     = rmin
    gkcoll_rmaj_in     = rmaj
  ...
  subroutine map_interface2global()
    ...
    k_theta  = gkcoll_k_theta_in
    r_length = gkcoll_r_length_in
    rmin     = gkcoll_rmin_in
    rmaj     = gkcoll_rmaj_in
