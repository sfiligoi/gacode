...
c
      ...
      real, allocatable, dimension(:) :: blank_d, bblank_d
      allocate (blank_d(nj), bblank_d(1000))
c
c---:----1----:----2----:----3----:----4----:----5----:----6----:----7-c
      pi_m=3.1415926D0
      xi=(0.D0,1.D0)
...
c nj : the size of the vectors printed in this file
         read(niterdb,'(a)') stflg
         read(niterdb,9) nj_d
         if(nj_d.gt.nj.and.i_proc.eq.0) write(*,900)nj,nj_d
...
c---:----1----:----2----:----3----:----4----:----5----:----6----:----7-c
 ...
 900  format(' Warning: nj_d larger than ',i4,' pts, nj_d = ',i3)
c
       end
c---:----1----:----2----:----3----:----4----:----5----:----6----:----7-c
