...
c      real*8  X(*), F(INCFD,*), D(INCFD,*), XE(*), FE(*)
      LOGICAL SKIP
C
...
c
c      write(*,*) 'inside dpchfe ...', N, INCFD, SKIP, NE
C
...
C
    5 CONTINUE
c      write(*,*) 'dpchfe, okay so far-1 ...', NE
c      do j=1,N
c        write(*,'(i2,2x,1p3e14.6)') j, x(j), F(1,j), D(1,j) 
c      enddo
c      do j=1,NE
c        write(*,'(i2,2x,1p3e14.6)') j, XE(j)
c      enddo
c
