...
C         ISIZEI = LOG10(FLOAT(I1MACH(9))) + 1.0
C         ISIZEF = LOG10(FLOAT(I1MACH(10))**I1MACH(11)) + 1.0
         ISIZEI = INT(LOG10(REAL(I1MACH(9))) + 1.0)
         ISIZEF = INT(LOG10(REAL(I1MACH(10))**I1MACH(11)) + 1.0)
         DO 50 KUNIT=1,NUNIT
            IUNIT = LUN(KUNIT)
