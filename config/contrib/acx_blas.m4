...
dnl
dnl Tech-X version:
dnl    $Id: acx_blas.m4 3617 2010-08-18 09:32:57Z cary $
dnl
...
case "$with_blas" in
  ...
  -framework*) acx_blas_libs="$with_blas" ;;
  *) acx_blas_libs="-l$with_blas" ;;
esac
# echo "acx_blas_libs = '$acx_blas_libs'"
...
# echo "After this and only this, acx_blas_ok = $acx_blas_ok"
dnl echo Check for one and only blas returned.
...
# echo "Before Darwin, acx_blas_ok = $acx_blas_ok"
# If on Darwin and not yet found, use -framework
if test $acx_blas_ok = no; then
  case "$host" in
    *-apple-darwin*)
      acx_blas_ok=yes
...
# echo "After generic, acx_blas_ok = $acx_blas_ok, acx_blas_libs = '$acx_blas_libs'"
