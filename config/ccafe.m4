...
dnl
dnl Version: $Id: ccafe.m4 2551 2008-02-01 23:02:35Z roopa $
dnl
...
CCASPEC_BABEL_XML_REPOSITORY=`grep CCASPEC_BABEL_XML_REPOSITORY $CCAFE_MAKEINCL | sed -e 's/^CCASPEC_BABEL_XML_REPOSITORY = //'`
