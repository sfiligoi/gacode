...
for arg in sys.argv:
    if arg == 'ps':
        ...
        ax1.plot(sim1.data['r/a'][-1], sim1.data['a/Lni'][-1])
        ax2 = fig.add_subplot(222)
        ax2.set_ylabel('a/Lne')
        ax2.set_xlabel('r/a')
        ax2.set_title('a/Lne vs. Radius')
        ax2.plot(sim1.data['r/a'][-1], sim1.data['a/Lne'][-1])
        ax3 = fig.add_subplot(223)
        ax3.set_ylabel('a/LTi')
        ax3.set_xlabel('r/a')
        ax3.set_title('a/LTi vs. Radius')
        ax3.plot(sim1.data['r/a'][-1], sim1.data['a/LTi'][-1])
        ax4 = fig.add_subplot(224)
        ax4.set_ylabel('a/LTe')
        ax4.set_xlabel('r/a')
        ax4.set_title('a/LTe vs. Radius')
        ax4.plot(sim1.data['r/a'][-1], sim1.data['a/LTe'][-1])
        plt.show()
    elif arg == 'cs':
        fig = plt.figure(fignum)
        fignum = fignum + 1
        ...
        ax1.plot(sim1.data['r/a'][-1], sim1.data['chie_tur'][-1])
        ax2 = fig.add_subplot(222)
        ax2.set_ylabel('chi_e_neo')
        ax2.set_xlabel('r/a')
        ax2.set_title('chi_e_neo vs. Radius')
        ax2.plot(sim1.data['r/a'][-1], sim1.data['chie_neo'][-1])
        ax3 = fig.add_subplot(223)
        ax3.set_ylabel('chi_i_turb')
        ax3.set_xlabel('r/a')
        ax3.set_title('chi_i_turb vs. Radius')
        ax3.plot(sim1.data['r/a'][-1], sim1.data['chii_tur'][-1])
        ax4 = fig.add_subplot(224)
        ax4.set_ylabel('chi_i_neo')
        ax4.set_xlabel('r/a')
        ax4.set_title('chi_i_neo vs. Radius')
        ax4.plot(sim1.data['r/a'][-1], sim1.data['chii_neo'][-1])
        plt.show()
    elif arg == 'fs':
        fig = plt.figure(fignum)
        fignum = fignum + 1
        ...
        ax1.plot(sim1.data['r/a'][-1], sim1.data['eflux_e_tur'][-1])
        ax2 = fig.add_subplot(222)
        ax2.set_ylabel('flux_e_neo')
        ax2.set_xlabel('r/a')
        ax2.set_title('flux_e_neo vs. Radius')
        ax2.plot(sim1.data['r/a'][-1], sim1.data['eflux_e_neo'][-1])
        ax3 = fig.add_subplot(223)
        ax3.set_ylabel('flux_i_turb')
        ax3.set_xlabel('r/a')
        ax3.set_title('flux_i_turb vs. Radius')
        ax3.plot(sim1.data['r/a'][-1], sim1.data['eflux_i_tur'][-1])
        ax4 = fig.add_subplot(224)
        ax4.set_ylabel('flux_i_neo')
        ax4.set_xlabel('r/a')
        ax4.set_title('flux_i_neo vs. Radius')
        ax4.plot(sim1.data['r/a'][-1], sim1.data['eflux_i_neo'][-1])
        plt.show() 
    elif arg == 'ms':
        fig = plt.figure(fignum)
        fignum = fignum + 1
        ...
        ax1.plot(sim1.data['r/a'][-1], sim1.data['mflux_e_tur'][-1])
        ax2 = fig.add_subplot(222)
        ax2.set_ylabel('mflux_e_neo')
        ax2.set_xlabel('r/a')
        ax2.set_title('mflux_e_neo vs. Radius')
        ax2.plot(sim1.data['r/a'][-1], sim1.data['mflux_e_neo'][-1])
        ax3 = fig.add_subplot(223)
        ax3.set_ylabel('mflux_i_turb')
        ax3.set_xlabel('r/a')
        ax3.set_title('mflux_i_turb vs. Radius')
        ax3.plot(sim1.data['r/a'][-1], sim1.data['mflux_i_tur'][-1])
        ax4 = fig.add_subplot(224)
        ax4.set_ylabel('mflux_i_neo')
        ax4.set_xlabel('r/a')
        ax4.set_title('mflux_i_neo vs. Radius')
        ax4.plot(sim1.data['r/a'][-1], sim1.data['mflux_i_neo'][-1])
        plt.show()
