...
subroutine logint1(z,x,n,fb,xs,f)
  ...
  ! Final subinterval
  dx = x(i0)-x(i0-1)
  f = f*exp(0.5/dx*(z(i0)*(dx**2-(x0-x(i0-1))**2)+z(i0-1)*(x0-x(i0))**2))

end subroutine logint1
