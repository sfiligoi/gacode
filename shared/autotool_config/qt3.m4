...
dnl
dnl Version:	$Id: qt3.m4 2662 2008-06-27 17:40:15Z sudhakar $
dnl
...
dnl ######################################################################
  ...
  TX_PATH_FILE(QAPPLICATION_H, qapplication.h, "", $QT_INCPATH)
...
dnl ######################################################################
  ...
  TX_PATH_FILE(ABSQT_LIB, ${QT_LIBNAME}${SO}, "", $QT_LIBPATH)
