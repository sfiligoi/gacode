...
AC_MSG_ERROR(22Nov09: qscimpl.m4 is disabled.  Please move to tx_qscimpl.m4)
...
TX_PATH_FILE(TXQPLOT_FRAME, TxqFrame.h, "", $TXQPLOT_INCPATH)
...
TX_PATH_FILE(TXQPLOT_BASE, libtxqbase.a, "", $TXQPLOT_LIBPATH)
