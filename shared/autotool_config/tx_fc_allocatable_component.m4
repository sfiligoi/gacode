...
#   in derived types.
#
#   $Id: tx_fc_allocatable_component.m4 2829 2008-12-09 13:57:59Z cary $
#
...
if test "$ac_cv_have_allocatable_component" = yes; then
   AC_DEFINE(HAVE_FC_ALLOCATABLE_COMPONENT,,
	[define if fortran compiler supports allocatable components])
fi
