pro transport_ne_te_ti_gradients_see, group=group
;
...
;
  ...
  if xregistered('transport_ne_te_ti_gradients_see') then return
  ;;-----------------------------------------------
  ...
  wlist = widget_button(w1,$
                        value='Electron density gradient',$
                        uvalue=1)  
  ...
  xmanager,$
    'transport_ne_te_ti_gradients_see', $
    base, $
    event='transport_ne_te_ti_gradients_event',$
    group_leader=group
