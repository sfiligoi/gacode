pro transport_ne_te_ti_profiles_see, group=group
;
...
;
  ...
  if xregistered('transport_ne_te_ti_profiles_see') then return
  ;;-----------------------------------------------
  ...
  wlist = widget_button(w1,value='Electron density',uvalue=1)  
  wlist = widget_button(w1,value='Electron temperature',uvalue=2)  
  wlist = widget_button(w1,value='Ion temperature',uvalue=3)
  ...
  xmanager,'transport_ne_te_ti_profiles_see', $
    base, $
    event='transport_ne_te_ti_profiles_event',$
    group_leader=group
