...
int read_complex(string file, int n_elements, float *xr, float *xi)
{
...
int read_real(string file, int n_elements, float *xr)
{
  ...
  for (int i=0; i<n_elements; i++) in >> xr[i];
