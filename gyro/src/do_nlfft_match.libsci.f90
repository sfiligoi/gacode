!--------------------------------------------------------------
! do_nlfft_match.libsci.f90 [caller: gyro_rhs_total]
!
! PURPOSE:
!  This routine evaluates the ExB nonlinearity with nonperiodic 
...
subroutine do_nlfft_match
  ...
  ! fn, gn and fgp have ip indices; must be zeroed.
