...
;
  ...
  IF (KEYWORD_SET(plot_T) AND data.exists_t) THEN BEGIN
      ...
      IF KEYWORD_SET(localnorm) THEN BEGIN
          lnorm =data.T_eq[data.i_kin,*]
          def_title += '(r)'
      ENDIF ELSE BEGIN
          lnorm = data.T_eq[data.i_kin,data.n_r/2]
          def_title += '(r!D0!N)'
      ENDELSE
  ...
  ENDIF ELSE IF (KEYWORD_SET(plot_E) AND data.exists_e) THEN BEGIN
      ...
      IF KEYWORD_SET(localnorm) THEN BEGIN
          lnorm = data.n_eq[data.i_kin,*]*data.T_eq[data.i_kin,*]
          def_title += '(r)'
      ENDIF ELSE BEGIN
          lnorm = data.n_eq[data.i_kin,data.n_r/2]*data.T_eq[data.i_kin,data.n_r/2]
          def_title += '(r!D0!N)'
      ENDELSE
  ENDIF ELSE IF (KEYWORD_SET(plot_n) AND data.exists_n) THEN BEGIN
      ...
      IF KEYWORD_SET(localnorm) THEN BEGIN
          lnorm = data.n_eq[data.i_kin,*]
          def_title += '(r)'
      ENDIF ELSE BEGIN
          lnorm = data.n_eq[data.i_kin,data.n_r/2]
          def_title += '(r!D0!N)'
      ENDELSE
  ENDIF ELSE BEGIN
      ...
      IF KEYWORD_SET(localnorm) THEN BEGIN
          lnorm = data.T_eq[data.n_spec-1,*]
          def_title += '(r)'
      ENDIF ELSE BEGIN
          lnorm = data.T_eq[data.n_spec-1,data.n_r/2]
	  def_title += '(r!D0!N)'
      ENDELSE	
  ENDELSE
